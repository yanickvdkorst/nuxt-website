...
import { _ as _sfc_main$4 } from './TekstAfbeelding-BvIlT6xX.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-gradient-to-br from-indigo-700 via-purple-800 to-pink-700 min-h-screen pt-24 pb-16 px-4 flex" }, _attrs))} data-v-8022cf82>`);
      if (unref(project)) {
        _push(`<div class="project-detail" data-v-8022cf82><div class="project-detail-banner w-full bg-white/90 rounded-2xl shadow-2xl p-10 border border-white/40 animate-fade-in-up flex flex-col md:flex-row gap-10" data-v-8022cf82><div class="w-full flex-1 flex flex-col gap-4 justify-center relative" data-v-8022cf82>`);
        ...
        _push(`<h1 class="text-4xl md:text-5xl font-extrabold text-indigo-800 drop-shadow-lg" data-v-8022cf82>${ssrInterpolate(unref(project).title)}</h1><p class="text-gray-700 text-lg" data-v-8022cf82>${ssrInterpolate(unref(project).description)}</p><div class="flex flex-wrap gap-2" data-v-8022cf82><!--[-->`);
        ssrRenderList(unref(project).tags, (tag, idx) => {
          _push(`<span class="inline-block bg-indigo-600 text-white text-xs font-semibold px-3 py-1 rounded-full shadow" data-v-8022cf82>${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div><div class="flex gap-4 items-center" data-v-8022cf82><a class="group flex items-center rounded-full text-indigo-600 bg-transparent font-semibold transition relative"${ssrRenderAttr("href", unref(project).github_link || "#")} target="_blank" rel="noopener" data-v-8022cf82><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 20 20" fill="none" data-v-8022cf82><path d="..." fill="#4F39F6" data-v-8022cf82></path></svg><span class="ml-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-indigo-700 whitespace-nowrap typewriter" data-v-8022cf82> Open GitHub </span></a></div></div><div class="flex-1 flex items-center justify-center" data-v-8022cf82>`);
        if (unref(project).image_url) {
          _push(`<img${ssrRenderAttr("src", unref(project).image_url)} alt="Project afbeelding" class="rounded-2xl shadow-lg object-cover h-full" data-v-8022cf82>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
        if (unref(project).fieldgroups) {
          _push(`<div class="mt-16 max-w-7xl mx-auto space-y-10" data-v-8022cf82><!--[-->`);
          ...
          _push(`<div class="mt-16 text-white text-center" data-v-8022cf82><p data-v-8022cf82>Geen blokken beschikbaar voor dit project.</p></div>`);
        }
        if (unref(project).footer == true) {
          _push(`<div class="mt-20 flex flex-col items-center text-center text-white" data-v-8022cf82><h3 class="text-2xl font-bold mb-2" data-v-8022cf82>Interested in this project?</h3><p class="mb-6 text-gray-100" data-v-8022cf82>Explore the source code on GitHub</p><a${ssrRenderAttr("href", unref(project).github_link || "#")} target="_blank" rel="noopener" class="inline-block px-8 py-3 rounded-full bg-indigo-600 text-white font-semibold shadow hover:bg-pink-600 transition" data-v-8022cf82> Open GitHub </a></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      } else {
        _push(`<div class="w-full max-w-2xl bg-red-50 text-red-700 rounded-2xl shadow-2xl p-10 border border-red-200 flex items-center justify-center" data-v-8022cf82><p data-v-8022cf82>Project niet gevonden.</p></div>`);
      }
      _push(`</div>`);
    };
  }
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8022cf82"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-CLX0aFtG.mjs.map
