...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-4xl font-extrabold text-center mb-32 mt-16 text-white drop-shadow-lg tracking-tight"> Mijn projecten </h1><div class="w-full px-4"><ul class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in-up"><!--[-->`);
...
//# sourceMappingURL=index-DhvyafP4.mjs.map
