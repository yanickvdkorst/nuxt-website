...
const _routes = [
  ...
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DItdIaLX.mjs')
  },
  {
    name: "projecten",
    path: "/projecten",
    component: () => import('./index-CCc2MTsi.mjs')
  },
  {
    name: "projecten-slug",
    path: "/projecten/:slug()",
    component: () => import('./_slug_-5IrHMk-p.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "text-2xl font-bold text-white hover:text-white transition-colors"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Golfcar Logo" class="w-12 h-12 inline-block mr-2"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0,
