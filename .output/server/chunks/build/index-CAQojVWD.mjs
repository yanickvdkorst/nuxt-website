...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative h-screen overflow-hidden bg-gradient-to-br from-indigo-700 via-purple-800 to-pink-700" }, _attrs))} data-v-1bb25ddb><div class="image" data-v-1bb25ddb><!--[-->`);
      ssrRenderList(unref(projects), (project, i) => {
        ...
        }, "absolute inset-0 w-full h-full object-cover transition-opacity duration-700"])}" data-v-1bb25ddb>`);
      });
      _push(`<!--]--></div>`);
              ...
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="max-w-4xl" data-v-1bb25ddb${_scopeId2}><h2 class="text-6xl font-extrabold mb-4 drop-shadow-lg" data-v-1bb25ddb${_scopeId2}>${ssrInterpolate(project.title || project.id)}</h2><div class="text-xl drop-shadow-lg" data-v-1bb25ddb${_scopeId2}><!--[-->`);
                    ssrRenderList(project.tags, (tag, idx) => {
                      _push3(`<span class="mr-2" data-v-1bb25ddb${_scopeId2}>${ssrInterpolate(tag)} `);
                      if (idx !== project.tags.length - 1) {
                        _push3(`<span data-v-1bb25ddb${_scopeId2}>\u2022</span>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</span>`);
                    ...
                    return [
                      ...
                      createVNode("div", { class: "max-w-4xl" }, [
                        createVNode("h2", { class: "text-6xl font-extrabold mb-4 drop-shadow-lg" }, toDisplayString(project.title || project.id), 1),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1bb25ddb"]]);

export { index as default };
//# sourceMappingURL=index-CAQojVWD.mjs.map
