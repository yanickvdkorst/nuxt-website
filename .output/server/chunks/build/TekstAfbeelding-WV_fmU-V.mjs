import { defineComponent, mergeProps, useAttrs, ref, computed, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from 'vue/server-renderer';
import { y as defu, z as withLeadingSlash, j as hasProtocol, k as joinURL, A as parseURL, B as encodeParam, C as encodePath } from '../nitro/nitro.mjs';
...
const ipxRuntime$fVR_Wf_45_uyQ0Pu1ty0tK2h08Yj_45T5_Tn7xVLRb8E_45Uc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$fVR_Wf_45_uyQ0Pu1ty0tK2h08Yj_45T5_Tn7xVLRb8E_45Uc, defaults: {} }
};
const useImage = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.blok.image) {
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: _ctx.blok.image,
          alt: "images",
          class: "w-full md:w-1/3 rounded-xl shadow-md"
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=TekstAfbeelding-WV_fmU-V.mjs.map
