...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-4xl font-extrabold text-center mb-32 mt-16 text-white drop-shadow-lg tracking-tight"> Mijn projecten </h1><ul class="grid grid-cols-3 sm:grid-cols-1 lg:grid-cols-3 gap-6 animate-fade-in-up"><!--[-->`);
...
//# sourceMappingURL=index-Py_7FJaq.mjs.map
